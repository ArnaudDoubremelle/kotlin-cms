...
--
-- Hôte : localhost
-- Généré le :  sam. 02 mars 2019 à 19:33
...
INSERT INTO `comments` (`id`, `idArticle`, `text`) VALUES
(2, 1, 'dzadaz'),
(3, 1, 'test');
...
(2, 'admin', '$2a$10$0/.cjz4Gc3.MQXyXXT7IaOH330g3IvvYdUYQaRRoS1nEf9mihtcdC');
...
ALTER TABLE `comments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `comments_idArticle_foreign` (`idArticle`);
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_idArticle_foreign` FOREIGN KEY (`idArticle`) REFERENCES `articles` (`id`) ON DELETE CASCADE;
COMMIT;
